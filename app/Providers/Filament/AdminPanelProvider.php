...
class AdminPanelProvider extends PanelProvider
{
    ...
    private function buildNavigationItems(): array
    {
        $sohibulMenus = [
            ...
            ['key' => 'rw9',     'label' => 'RW 9',    'sort' => 5],
            ['key' => 'rw10',    'label' => 'RW 10',   'sort' => 6],
            ['key' => 'rw11',    'label' => 'RW 11',   'sort' => 7],
            ['key' => 'rw12',    'label' => 'RW 12',   'sort' => 8],
            ['key' => 'luar',    'label' => 'JAMAAH LUAR', 'sort' => 9],
            ['key' => 'kas',     'label' => 'KAS',         'sort' => 10, 'roles' => ['bendaharasapi']],
            ['key' => 'rek_program', 'label' => 'REK. PROGRAM', 'sort' => 11, 'roles' => ['bendaharasapi']],
            ['key' => 'rek_qurban',  'label' => 'REK. BENDAHARA',  'sort' => 12, 'roles' => ['bendaharasapi']],
        ];
