    ...
    @else
        ...
        <section class="group-section">
            ...
            <div class="grid-layout">
                ...
                <div id="card_block_1" class="card">
                ...
                <!-- Block 2: PENGELETAN -->
                <div id="card_block_2" class="card">
                    <div class="card-header">
                ...
                <!-- Block 3: PENIMBANGAN -->
                <div id="card_block_3" class="card">
                    <div class="card-header">
        ...
        <section class="group-section">
            ...
            <div class="grid-layout">
                ...
                <div id="card_block_4" class="card">
                    <div class="card-header">
                ...
                <div id="card_block_5" class="card">
                    <div class="card-header">
                ...
                <div id="card_block_6" class="card">
                    <div class="card-header">
